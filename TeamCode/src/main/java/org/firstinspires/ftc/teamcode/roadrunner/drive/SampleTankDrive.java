...
public class SampleTankDrive extends TankDrive {
    // TODO: Tune this in the off-chance that we run tank, otherwise delete this.
    ...
    public SampleTankDrive(HardwareMap hardwareMap) {
        ...
        DcMotorEx leftFront = hardwareMap.get(DcMotorEx.class, RobotMap.MOTOR_FL);
        DcMotorEx leftRear = hardwareMap.get(DcMotorEx.class, RobotMap.MOTOR_BL);
        DcMotorEx rightRear = hardwareMap.get(DcMotorEx.class, RobotMap.MOTOR_BR);
        DcMotorEx rightFront = hardwareMap.get(DcMotorEx.class, RobotMap.MOTOR_FR);
